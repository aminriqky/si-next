            ...
            <Box fontSize={{ base: "xs", lg: "md" }}>
              <div
                dangerouslySetInnerHTML={{
                  __html:
                    daftarProfil !== undefined
                      ? daftarProfil[12].text
                      : "Loading...",
                }}
              />
            </Box>
